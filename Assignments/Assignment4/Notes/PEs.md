...
- **Location**: `\VOLUME{01d57f73e5f614a0-a2e60e11}\USERS\CRAIG\DOWNLOADS\MINESWEEPERZ.EXE`
- **Prefetch Entry**: `"victim_01.disk.raw - Partition 4 (Microsoft NTFS, 59.4 GB) Windows\Windows\Prefetch\MINESWEEPERZ.EXE-ABF2F612.pf"`
- **Execution Count**: 4
- **Execution Timestamp**: First executed on `14/10/2019 4:25:35 AM`
- **Last Execution Timestamp**: Last executed on `14/10/2019 4:46:31 AM`
...
This log record provides an overview of `Minesweeperz.exe` based on its properties, VirusTotal analysis, and execution artifacts.
